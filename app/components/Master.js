...
<div className="text-black font-bold text-[#82704e] md:text-4xl text-2xl md:mt-0 mt-5 md:mx-140 mx-15 dark:text-white w-full font-[marcellus]">
...
<div className=" py-20 flex justify-center ">
     ...
     <div className="relative flex flex-col items-center">
          ...
          <div className="absolute bottom-[-35px] bg-[#7b6749] text-white px-10 py-3 text-center text-lg font-semibold clip-ribbon">
            <p className="text-xl font-[marcellus]">Petro William</p>
            <p className="text-sm font-normal tracking-wide">
              MAIN CHEF
            </p>
          </div>
